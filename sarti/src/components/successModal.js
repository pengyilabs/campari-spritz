    ...
    <div class="result-modal-container">
      ...
      <div class="result-modal-content">
        ...
        <div class="result-modal-text">
          ...
          <p>Check deine Inbox für deinen QR-Code und bring ihn mit zu <span class="result-modal-place-name">${place.name}</span> um deinen kostenlosen Sarti Spritz zu erhalten!</p>
        </div>
